...
namespace Menues
{
  void Menu_Login(sUsuario vrUsuarios[], sUsuario &rUsuario);
  void Menu_Principal(sUsuario rUsuario);
  void Menu_Cuentas(sMovimientoCA vrMovimientosCA[], int cardMovCA);
  void Submenu_Cuentas(sMovimientoCA vrMovimientosCA[], int &cardMovCA, short divisa, bool bruto);
  ...
  void Menu_Cuentas(sMovimientoCA vrMovimientosCA[], int cardMovCA)
  {
    ...
    Submenu_Cuentas(vrMovimientosCA, cardMovCA, opcionSeleccionada, false);
  }
...
void SistemaHomeBanking()
{
  ...
  BarraTitulo();
  Menues::Menu_Login(vrUsuarios, rUsuario);
  Menues::Menu_Principal(rUsuario);
}
